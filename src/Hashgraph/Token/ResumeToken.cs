...
namespace Hashgraph
{
    public partial class Client
    {
        ...
        public async Task<TransactionReceipt> ResumeTokenAsync(Address token, AddressOrAlias address, Action<IContext>? configure = null)
        {
        ...
        /// <exception cref="ConsensusException">If the network was unable to come to consensus before the duration of the transaction expired.</exception>
        /// <exception cref="TransactionException">If the network rejected the create request as invalid or had missing data.</exception>
        public async Task<TransactionReceipt> ResumeTokenAsync(Address token, AddressOrAlias address, Signatory signatory, Action<IContext>? configure = null)
        {
        ...
        /// <exception cref="ConsensusException">If the network was unable to come to consensus before the duration of the transaction expired.</exception>
        /// <exception cref="TransactionException">If the network rejected the create request as invalid or had missing data.</exception>
        public async Task<TransactionRecord> ResumeTokenWithRecordAsync(Address token, AddressOrAlias address, Action<IContext>? configure = null)
        {
        ...
        /// <exception cref="ConsensusException">If the network was unable to come to consensus before the duration of the transaction expired.</exception>
        /// <exception cref="TransactionException">If the network rejected the create request as invalid or had missing data.</exception>
        public async Task<TransactionRecord> ResumeTokenWithRecordAsync(Address token, AddressOrAlias address, Signatory signatory, Action<IContext>? configure = null)
        {
