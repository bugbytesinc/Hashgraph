...
public partial class Client
{
    ...
    public async Task<TransactionReceipt> AssociateTokenAsync(Address token, AddressOrAlias account, Action<IContext>? configure = null)
    {
    ...
    /// <exception cref="ConsensusException">If the network was unable to come to consensus before the duration of the transaction expired.</exception>
    /// <exception cref="TransactionException">If the network rejected the create request as invalid or had missing data.</exception>
    public async Task<TransactionReceipt> AssociateTokensAsync(IEnumerable<Address> tokens, AddressOrAlias account, Action<IContext>? configure = null)
    {
    ...
    /// <exception cref="ConsensusException">If the network was unable to come to consensus before the duration of the transaction expired.</exception>
    /// <exception cref="TransactionException">If the network rejected the create request as invalid or had missing data.</exception>
    public async Task<TransactionReceipt> AssociateTokenAsync(Address token, AddressOrAlias account, Signatory signatory, Action<IContext>? configure = null)
    {
    ...
    /// <exception cref="ConsensusException">If the network was unable to come to consensus before the duration of the transaction expired.</exception>
    /// <exception cref="TransactionException">If the network rejected the create request as invalid or had missing data.</exception>
    public async Task<TransactionReceipt> AssociateTokensAsync(IEnumerable<Address> tokens, AddressOrAlias account, Signatory signatory, Action<IContext>? configure = null)
    {
    ...
    /// <exception cref="ConsensusException">If the network was unable to come to consensus before the duration of the transaction expired.</exception>
    /// <exception cref="TransactionException">If the network rejected the create request as invalid or had missing data.</exception>
    public async Task<TransactionRecord> AssociateTokenWithRecordAsync(Address token, AddressOrAlias account, Action<IContext>? configure = null)
    {
    ...
    /// <exception cref="ConsensusException">If the network was unable to come to consensus before the duration of the transaction expired.</exception>
    /// <exception cref="TransactionException">If the network rejected the create request as invalid or had missing data.</exception>
    public async Task<TransactionRecord> AssociateTokensWithRecordAsync(IEnumerable<Address> tokens, AddressOrAlias account, Action<IContext>? configure = null)
    {
    ...
    /// <exception cref="ConsensusException">If the network was unable to come to consensus before the duration of the transaction expired.</exception>
    /// <exception cref="TransactionException">If the network rejected the create request as invalid or had missing data.</exception>
    public async Task<TransactionRecord> AssociateTokenWithRecordAsync(Address token, AddressOrAlias account, Signatory signatory, Action<IContext>? configure = null)
    {
    ...
    /// <exception cref="ConsensusException">If the network was unable to come to consensus before the duration of the transaction expired.</exception>
    /// <exception cref="TransactionException">If the network rejected the create request as invalid or had missing data.</exception>
    public async Task<TransactionRecord> AssociateTokensWithRecordAsync(IEnumerable<Address> tokens, AddressOrAlias account, Signatory signatory, Action<IContext>? configure = null)
    {
