...
internal sealed class Invoice : IInvoice
{
    ...
    int IInvoice.MinimumDesiredPrefixSize { get { return _prefixTrimLimit; } }

    internal Invoice(TransactionBody transactionBody, int prefixTrimLimit)
    {
    ...
    internal SignedTransaction GenerateSignedTransactionFromSignatures()
    {
