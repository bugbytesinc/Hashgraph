...
public partial class Client
{
    ...
    public async Task<TransactionReceipt> DeleteAccountAsync(AddressOrAlias addressToDelete, AddressOrAlias transferToAddress, Action<IContext>? configure = null)
    {
