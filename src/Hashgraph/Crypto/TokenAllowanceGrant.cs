...
/// </summary>
public sealed record TokenAllowanceGrant
{
    /// <summary>
    ...
    /// </exception>
    public TokenAllowanceGrant(Address token, Address owner, Address agent, long amount)
    {
    ...
    /// </summary>
    internal TokenAllowanceGrant(Proto.TokenAllowance allowance)
    {
