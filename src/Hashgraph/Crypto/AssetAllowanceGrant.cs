...
/// </summary>
public sealed record AssetAllowanceGrant
{
    /// <summary>
    ...
    /// </exception>
    public AssetAllowanceGrant(Address token, Address owner, Address agent, IReadOnlyCollection<long>? serialNumbers = null)
    {
    ...
    /// If any of the addresses are null or empty.
    /// </exception>
    public AssetAllowanceGrant(Asset asset, Address owner, Address agent)
    {
    ...
    /// </summary>
    internal AssetAllowanceGrant(Proto.NftAllowance allowance)
    {
