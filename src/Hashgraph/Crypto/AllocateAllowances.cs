...
public partial class Client
{
    ...
    public async Task<TransactionReceipt> AllocateAsync(AllowanceParams allowanceParams, Action<IContext>? configure = null)
    {
    ...
    /// <exception cref="ConsensusException">If the network was unable to come to consensus before the duration of the transaction expired.</exception>
    /// <exception cref="TransactionException">If the network rejected the create request as invalid or had missing data.</exception>
    public async Task<TransactionRecord> AllocateWithRecordAsync(AllowanceParams allowanceParams, Action<IContext>? configure = null)
    {
