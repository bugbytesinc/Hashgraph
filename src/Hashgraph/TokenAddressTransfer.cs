...
namespace Hashgraph
{
    ...
    /// </summary>
    public sealed class TokenAddressTransfer : IEquatable<TokenAddressTransfer>
    {
        /// <summary>
        ...
        /// values indicate an inflow of coins from the associated <code>Account</code>.
        /// </param>
        internal TokenAddressTransfer(Address token, Address address, long amount)
        {
            Token = token;
            Address = address;
            Amount = amount;
        ...
        /// </returns>
        public bool Equals(TokenAddressTransfer? other)
        {
            if (other is null)
            {
                return false;
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (obj is TokenAddressTransfer other)
            {
                return Equals(other);
            }
            return false;
        ...
        /// </returns>
        public static bool operator ==(TokenAddressTransfer left, TokenAddressTransfer right)
        {
            if (left is null)
            {
        ...
        /// <returns></returns>
        internal TokenAddressTransfer Add(long amount)
        {
            return new TokenAddressTransfer(Token, Address, Amount + amount);
        }
    }
}
